...
Step1:
Prep_images_Galfit, name, INFILE, WHTFILE , ZP , pix_size, OBJFILE, SEGFILE , MASKFILE, OUTFILE, GALFILE, NOISEFILE, PSFFILE,GALOUT, SEX_DETECT_THRESH, SEX_ANALYSIS_THRESH, DEBLEND_MINCONT, DEBLEND_NTHRESH
...
Step3:
; Run Galfit
spawn, 'galfit '+GALFILE 

Step4:
spawn, 'galfit -o3 galfit.01' 
...
Step5:
GALOUT_IMAGES,GALOUT, OUTEPS1, OUTEPS2, OUTEPS3, REDSHIFT=redshift,KPC_SCALE=Scale_Kpc,MSKFILE=MASKFILE,PIXSCALE=pix_size,Z_label='e-/s'
plotprofile,ZP,pix_size,'',GALLOG2, SUBCOMPS, OUTEPS_profile,xaxis_unit='kpc',redshift=redshift,scale=80.,exptime=exptime
Ds9_make, GALOUT, DS9FILE
spawn, 'chmod 755 '+DS9FILE

TOTEXFILE=PATH_GALFIT+name+ '.tex'
TODIVFILE=PATH_GALFIT+name+ '.dvi'
TOPSFILE=PATH_GALFIT+name+ '.pdf'
TOTABLEFILE=PATH_GALFIT+name+ '_galfit_table.png'
